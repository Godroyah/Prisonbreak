...
public class PlayerController : MonoBehaviour {
    ...
    public void ControlToWorld(Transform playerTrans, Transform camera, ref float directionOut, ref float speedOut)
    {
        ...
        //***Reference I followed to construct the "Follow-Cam" can be found @: https://www.youtube.com/watch?v=b0PvJ4AWvWQ by John Mac***
        //Videos 5-9 deal with camera construction
    }
